...
dict_cogn = {'L.NARTIQ': 'L.NARTIQ',
 ...
 'E.m.DiffBrtArt': 'E.m.DiffBrtArt',
 'E.m.hsctE45': 'HSCT: global error score',
 'E.PropCStrat': 'E.PropCStrat',
 'E.FAS': 'FAS: total correct',
 'E.m.FAS15:45': 'E.m.FAS15:45',
 'E.m.FAS%Terr': 'E.m.FAS%Terr',
 'E.DStotal': 'E.DStotal',
...
for ax, axh, x in zip([axes[0, 0], axes[0, 2]], 
    ...
    df['dv'] = x
    for gr, th in zip([[1, 2], [2, 3], [1, 3]], [0, 5, 20]):
